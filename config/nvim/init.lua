...
-- Quit Neovim when only neo-tree buffer remains
...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Statusline disabled in favor of lualine (see below)
  ...
  -- Git integration
  {
    ...
    keys = {
      ...
      { '<leader>gl', ':Git log --oneline --graph --all<CR>', desc = 'Git log (graph)' },
    },
  },
  ...
  -- Rainbow colored brackets/delimiters
  {
  ...
  -- Side-by-side git diff viewer
  {
    ...
    keys = {
      { '<leader>gD', ':DiffviewOpen<CR>', desc = 'Git diffview' },
  ...
  -- Kubernetes management
  {
    ...
    config = function()
      require('kubectl').setup {
        kubectl_cmd = { cmd = 'kubectl', args = { '--context=arn:aws:eks:eu-west-1:844654352679:cluster/generous-leopard' } },
      }
    end,
  },
}, {
